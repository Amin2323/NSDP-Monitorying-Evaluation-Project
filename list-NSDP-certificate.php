		...
		<script type="text/javascript">
			...
			$(document).ready(function () {
				$("#btnAddNewProject").click(function(){
					window.location.href = "add-NSDP-certificate.php";
				});
				...
				$(".delete-project").click(function(event){
					...
					if (r === true) {
						...
						$.ajax({
							type: "GET",
							url: "delete-NSDP-certificate.php?id=" + projectId,
...
?>
  <div id="main">
	...
	<table id="attendance">
		...
		<tbody>
			<?php
				$query = "SELECT  Certificate_ID, Name, FatherName, PrintDate, RegNum, certificate, Department, fileName, path from NSDPcertificatesview";
				...
				{ ?>
					<tr>
                        ...
                        <td><a href='uploads/<?php echo $row[7]; ?>' download> <?php echo $row[7]; ?> </a></td>
						<td>
							<a href="#" class="delete-project" CertificateId="<?php echo $row[0]; ?>"><img src="images/delete.png" /></a>
							<a href="edit-NSDP-certificate.php?id=<?php echo $row[0]; ?>"><img src="images/edit.png" /></a>
						</td>						
						<td></td>
					</tr>							
				<?php
