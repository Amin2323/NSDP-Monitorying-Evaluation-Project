...
?>
  <div id="main">
	...
	<form id="add-trainee" action="process-add-trainee-detail.php" method="POST">
		<table>			
		...
		<tbody>
			<?php
				...
				if(!isset($_SESSION['traineeID'])){
					//$null = null;
						$query = "SELECT traineeID, traineeNameEng, fatherNameEng, genderEnglish, contactAddressEng, languageEnglish, maritalStatusEnglish, disabilityEnglish, districtName, villageName, tradeName, contactPhoneNumber, contactEmail FROM traineeview3 where userID = '{$userID}' and cenTrnTraID IS NULL  ";
						echo 'this is the key';
						
					} else {
						$traineeIDa= $_SESSION['traineeID'];
						echo $traineeIDa;
						$query = "SELECT traineeID, traineeNameEng, fatherNameEng, genderEnglish, contactAddressEng, languageEnglish, maritalStatusEnglish, disabilityEnglish, districtName, villageName, tradeName, contactPhoneNumber, contactEmail FROM traineeview3 where (userID = '{$userID}' and traineeID = {'$traineeIDa'}) and IS NULL  ";
						unset($_SESSION['traineeID']);
						$result = $mysqli->query($query);	
						while($row = $result->fetch_array(MYSQLI_NUM))
						}
						$result = $mysqli->query($query);	
				...
				?>
						...
						<tr>
							<td>
								<a href="#" class="Select-trainee" traineeId="<?php echo $row[0]; ?>"><img src="images/delete.png" /></a>
								<a href="add-trainee-detail.php?id=<?php echo $row[0]; ?>"><img src="images/edit.png" /></a>
							</td>
							...
							<td>
								<a href="#" class="delete-trainee" traineeId="<?php echo $row[0]; ?>"><img src="images/delete.png" /></a>
